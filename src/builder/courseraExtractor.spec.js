...
import { extractFromCoursera, getAllCourses, getInvididualCourses } from './courseraExtractor';
...
describe('#courseraExtractor', () => {
  ...
  it('should get individual courses', async () => {
    axiosMock.onGet(INDIVIDUAL_COURSE_SEARCH_URL('slug1'))
      .reply(200, generateIndividualCourseHTMLResponse());
    axiosMock.onGet(INDIVIDUAL_COURSE_SEARCH_URL('slug2'))
      .reply(200, generateIndividualCourseHTMLResponse());
  ...
  it('should perform complete extraction', async () => {
    ...
    axiosMock.onGet(INDIVIDUAL_COURSE_SEARCH_URL('slug2'))
      .reply(200, generateIndividualCourseHTMLResponse());
    axiosMock.onGet(INDIVIDUAL_COURSE_SEARCH_URL('slug3'))
      .reply(200, generateIndividualCourseHTMLResponse());
