...
const ALL_COURSE_SEARCH_URL = 'https://www.coursera.org/api/catalogResults.v2';
...
const getCourseSlugsFromAllCourses = allCourses =>
  allCourses
...
export const extractFromCoursera = async logger => {
